...
<center class="wrapper" style="width:100%;table-layout:fixed;-webkit-text-size-adjust:100%;-ms-text-size-adjust:100%;background-color:#ececec;">
  ...
  <!--                                                      <tr>
                ...
                <table class="one-column" border="0" cellpadding="0" cellspacing="0" width="100%" style="border-spacing:0" bgcolor="#FFFFFF">
                  <tr>
                    <td align="center" style="padding:0px 40px 0px 40px"><p style="color:#5b5f65; font-size:27px; text-align:center; font-family: Verdana, Geneva, sans-serif"><strong> Confirmación de Compra. </strong> </p>
                      <p style="color:#5b5f65; font-size:16px; text-align:left; font-family: Verdana, Geneva, sans-serif">Felicidades, se ha elegido la propuesta de Compra para la adquisición de la Convocatoria: <br><br>
                        Título: <b> "<?php echo $txttitulo; ?>" </b> <br>
                        Categoría: <b> "<?php echo $txtcat; ?>" </b> <br>
                        Detalle: "<?php echo $mensajeAd; ?>" 
                      </p>

                       <p style="color:#5b5f65; font-size:16px; text-align:left; font-family: Verdana, Geneva, sans-serif">El administrador del Sistema se pondrá en contacto en breve con usted.</b></p>

                      <p style="color:#5b5f65; font-size:16px; text-align:left; font-family: Verdana, Geneva, sans-serif">Para cualquier consulta envíanos un correo a <a href="mailto:compras@incotec.cc">compras@incotec.cc</a>,
                      o envíanos una consulta en el formulario de consultas dentro del "Sistema de Compras de Incotec". </p>
