    ...
    <div class="wrapper" id="body_principal">
      ...
      <header class="main-header">
        ...
        <a href="http://taxicorp.esy.es" target="_blanck" class="logo">
          ...
          <span class="logo-mini"><b style="color: #026EAE; font-family: serif; font-size: 27px;">ICT</b></span>

          <!-- logo for regular state and mobile devices -->

          <!--<span class="logo-lg"> <img src="<?php echo e(asset('images/log.png')); ?>" class="img-responsive" style="max-width: 81%;"> </span> -->         
          <span class="logo-lg"><b style="color: #026EAE; font-family: serif; font-size: 43px;">INCOTEC</b></span>
        </a>
          ...
          <ul class="sidebar-menu">
            ...
            <li class="treeview">
              ...
              <ul class="treeview-menu">
                 <li><a href="<?php echo URL::to('convocatoriasaprobadas'); ?>"><i class="fa fa-circle-o"></i> Aprobadas </a></li>
                      ...
                      <?php  $cat = DB::select('select categoria.idcat, nombre FROM prov_cat, categoria, proveedor WHERE categoria.idcat=prov_cat.idcat and proveedor.id=prov_cat.id AND proveedor.id='.Auth::user()->id); ?>
                        ...
                        <?php foreach($cat as $mov): ?>
                          ...
                          <a href="<?php echo URL::to($ruta); ?>">
                            ...
                            <button class="btn btn-primary" type="button" style="font-size: 17px;">
          ...
          <!-- div class="navbar-custom-menu pull-right">
            <ul class="nav navbar-nav">
              ...
              <li class="dropdown user user-menu">
                ...
                <?php  $public = DB::select('select COUNT(*) as nro FROM proveedor, categoria, prov_cat, convocatoria WHERE categoria.idcat=prov_cat.idcat and proveedor.id=prov_cat.id AND convocatoria.idcat=categoria.idcat AND convocatoria.estado="activa" AND proveedor.id='.Auth::user()->id); ?>
